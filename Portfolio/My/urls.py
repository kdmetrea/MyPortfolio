...
urlpatterns = [
    ...
    path('api/V1/Post/<str:slug>/',ControlPost.as_view()),
    path('api/V1/Massage/<str:Chat>/',ControlMassage.as_view()),
    ...
    path('api/V1/DeleteMassage/<int:id>/',DeleteMassage.as_view()),
